  ...
  return (
    <div className={darkMood ? "dark" : ""}>
      ...
      <main className="bg-white px-10 dark:bg-gray-900">
        ...
        <section className="min-h-screen justify-center ">
          <div className="text-center p-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-400">
              Welcome to my portfolio website! I'm Imam Uddin, an AI enthusiast
              and freelance programmer passionate about harnessing the power of
              artificial intelligence to solve complex problems and create
              innovative solutions. With a strong background in programming and
              a keen interest in AI technologies, I offer a wide range of
              services to meet your project needs.
            </p>
          </div>
          <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">
            <a
              href="https://x.com/ImamUddin_bd"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/in/imam-uddin-iu"
              target="_blank"
              rel="noopener noreferrer"
            >
              <AiFillLinkedin />
        ...
        <section>
          <div className="dark:text-gray-300 py-10" id="services">
            <h3 className="text-3xl py-1">Service I offer</h3>
            <p className="text-md py-2 leading-8 text-gray-80">
              AI Solutions: From machine learning models to natural language
              processing systems, I develop AI-powered solutions that leverage
              cutting-edge technologies to drive innovation and deliver tangible
              results.
            </p>
          </div>
          <div className="lg:flex flex justify-between gap-10 dark:text-gray-300 ">
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-slate-800">
              <Image
                src={mob}
                alt=""
                className="relative mx-auto h-93 w-93 m-24"
              />
              <div />
              <div>
        ...
        <section id="works">
          <h3 className="dark:text-gray-300 text-3xl py-1 m-4 py-24">
            My Works
          </h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="grid gap-4">
              <div>
                <iframe
                  className="max-w-full sm:w-1/2 lg:w-full h-[500px] rounded-lg fit"
                  src="https://beautiful-sprinkles-8b03cc.netlify.app/"
                ></iframe>
                {/* <img
            ...
            <div className="grid gap-4">
              <div>
                <iframe
                  className="max-w-full sm:w-1/2 lg:w-full h-[500px] rounded-lg fit"
                  src="https://portfolio-iu.vercel.app/"
                ></iframe>
                {/* <img
                  className="h-auto max-w-full rounded-lg"
            ...
            <div className="grid gap-4">
              <div>
                <iframe
                  className="max-w-full sm:w-1/2 lg:w-full h-[500px] rounded-lg fit"
                  src="https://eclectic-ganache-053f7b.netlify.app/"
                ></iframe>
                {/* <img
                  className="h-auto max-w-full rounded-lg"
